...
class TokenBudgetTracker:
    ...
    def _reset(self):
        ...
        self.cache_hits         = 0
        self.model_20b_calls     = 0
        self.model_120b_calls    = 0
    ...
    def record_query(
        ...
        with self._lock:
            ...
            # Track model usage
            if "20b" in model_used.lower():
                self.model_20b_calls += 1
            else:
                self.model_120b_calls += 1
    ...
    def get_budget_summary(self) -> dict:
        ...
        with self._lock:
            ...
            api_calls = self.model_20b_calls + self.model_120b_calls
            return {
                ...
                "model_20b_calls":     self.model_20b_calls,
                "model_120b_calls":    self.model_120b_calls,
